...
{
    default int[] encontrarPerfectos(int start, int end)
    {
        return encontrarPerfectos(start, end, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int[] encontrarPerfectos(int start, int end, java.util.Map<String, String> context)
    {
        return _iceI_encontrarPerfectosAsync(start, end, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<int[]> encontrarPerfectosAsync(int start, int end)
    {
        return _iceI_encontrarPerfectosAsync(start, end, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<int[]> encontrarPerfectosAsync(int start, int end, java.util.Map<String, String> context)
    {
        return _iceI_encontrarPerfectosAsync(start, end, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<int[]> _iceI_encontrarPerfectosAsync(int iceP_start, int iceP_end, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<int[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "encontrarPerfectos", null, sync, null);
